    ...
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <div className="flex flex-1 flex-col px-4 pb-8 pt-4">
        ...
        <button
          ...
          className="mt-6 flex w-full items-center justify-center rounded-2xl bg-accent px-6 py-4 text-center text-base font-semibold text-surface shadow-card transition-transform active:scale-[0.98]"
        >
