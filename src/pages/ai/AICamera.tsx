      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
        ...
        <div className="absolute inset-x-0 bottom-8 flex flex-col items-center gap-4">
          ...
          <button
            ...
            className="relative flex h-20 w-20 items-center justify-center rounded-full border-4 border-[#556B2F] bg-[#556B2F]/20"
            aria-label="Спуск затвора"
          >
            <span className="h-12 w-12 rounded-full bg-[#556B2F]" />
          </button>
        </div>
      </div>

      {isUploading ? (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/80 px-6 text-white">
